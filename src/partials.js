    ...
    <div class="shell">
      <div class="header-inner">
        ...
        <nav class="nav" aria-label="主导航" data-navigation>
          <a href="${rootPrefix}index.html">首页</a><a href="${rootPrefix}pricing.html">定价</a><a href="${rootPrefix}privacy-policy.html">隐私</a><a href="${rootPrefix}terms-of-service.html">条款</a><a class="nav-cta" href="${rootPrefix}downloads/ChargePilot-0.3.18.dmg">下载 v0.3.18</a>
        </nav>
      </div>
    </div>
  </header>`;
